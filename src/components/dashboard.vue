<template>
  <section>
    <el-row>
      ...
      <el-col :span="3">
        <el-button class="view-btn" @click="viewCap">view CAP range</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :offset="2" :span="16">
        <el-table :data="tableData.results" stripe style="width: 100%">
          <el-table-column
    ...
    <el-dialog title :visible.sync="openDialog" width="30%" center>
      <span>Your expected CAP falls in the range of:</span>
      <br>
      <span class="honor">{{honours}}</span>
      <span slot="footer" class="dialog-footer">
        <el-button @click="openDialog = false">cancel</el-button>
        <el-button type="primary" @click="openDialog = false">ok</el-button>
      </span>
    </el-dialog>
  </section>
</template>
