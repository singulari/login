<template>
  <section class="questions">
    <el-form ref="question" :model="form" :rules="rules" style="width:80%;margin:0 auto">
      <el-form-item v-for="(item,index) in questions" v-bind:key="index" :prop="item.name">
        <el-row type="flex">
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit('question')">submit</el-button>
